...
import { Collapsible, TimeInsights, DeviceInsights, usePeopleCount } from "@/components/ops/OpsInsights";
import { OpsOverview } from "@/components/ops/OpsOverview";
import { formatMinutes, netMinutes, useDevices, useTimeEntries, useTimeEntriesForProjects } from "@/lib/opsStore";
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto slim-scroll">
          {hub === "home" ? (
            ...
            <OpsOverview projects={projects.map((p) => ({ id: p.id, name: p.name }))} />
 ...
 */
/**
 * Reiter „Organisation“ im geöffneten Projekt auf der Startseite.
 *
 * Nutzt dasselbe Umfeld wie die projektübergreifende Organisation
 * (`OpsOverview`) – kein Kopie-Code. Der Projektbereich ist fest auf
 * das geöffnete Projekt gesetzt (Aktionen, Kalender, Beiträge,
 * Zeiterfassung, Geräte/Werkzeuge, Projektstände).
 */
