...
export class PointEditMenu {
  ...
  actions = [PointEditAction.MOVE, PointEditAction.TRANSLATE, PointEditAction.ROTATE, PointEditAction.SCALE, PointEditAction.OFFSET, PointEditAction.INSERT_POINT, PointEditAction.RESIZE, PointEditAction.DUPLICATE, PointEditAction.BULGE, PointEditAction.SPLIT, PointEditAction.DELETE];
